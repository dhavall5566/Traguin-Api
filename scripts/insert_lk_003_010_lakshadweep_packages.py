#!/usr/bin/env python3
"""Insert LK-003 through LK-010 Lakshadweep packages (no images, skip if exists)."""
...
from lakshadweep_lk_batch_defs import LAKSHADWEEP_DESTINATION_ID, LAKSHADWEEP_LK_BUILDERS
...
def main() -> None:
    ...
    with SessionLocal() as db:
        ...
        for builder in LAKSHADWEEP_LK_BUILDERS:
