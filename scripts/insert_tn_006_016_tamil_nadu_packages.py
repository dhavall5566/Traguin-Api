#!/usr/bin/env python3
"""Insert TN-006 through TN-016 Tamil Nadu packages (no images, skip if exists)."""
...
from tamil_nadu_domestic_batch_defs import TAMIL_NADU_DOMESTIC_BUILDERS, TAMIL_NADU_SLUG
...
def main() -> None:
    ...
    with SessionLocal() as db:
        ...
        for builder in TAMIL_NADU_DOMESTIC_BUILDERS:
