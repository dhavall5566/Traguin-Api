#!/usr/bin/env python3
"""Insert GJ-006 through GJ-019 Gujarat packages (no images, skip if exists)."""
...
from gujarat_domestic_batch_defs import GUJARAT_DESTINATION_ID, GUJARAT_DOMESTIC_BUILDERS
...
def main() -> None:
    ...
    with SessionLocal() as db:
        ...
        for builder in GUJARAT_DOMESTIC_BUILDERS:
